    ...
    <div className="relative flex flex-col w-full min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <header className="flex items-center justify-between border-b border-yellow-500/10 px-6 py-4 lg:px-20 bg-zinc-950 sticky top-0 z-50">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/" className="text-sm font-medium hover:text-yellow-500 transition-colors">Home</Link>
          <Link href="/features" className="text-sm font-medium hover:text-yellow-500 transition-colors">Features</Link>
          <Link href="/pricing" className="text-sm font-medium hover:text-yellow-500 transition-colors">Pricing</Link>
          <Link href="/support" className="text-sm font-medium hover:text-yellow-500 transition-colors">Support</Link>
          <SignedOut>
      ...
      <footer className="bg-zinc-950 py-12 px-6 mt-auto border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8 text-sm font-medium text-zinc-500">
            ...
            <Link href="/release-notes" className="hover:text-yellow-500 transition-colors">Release Notes</Link>
            <Link href="/support" className="hover:text-yellow-500 transition-colors">Help Center</Link>
          </div>
